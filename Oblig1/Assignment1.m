...
%feas = feas_check1(sol, veh_call,C,V)

%feas = feas_check2(sol, vehicle_spec, call_spec, C, V)

%feas = feas_check3(sol, vehicle_spec, call_spec, route_spec, load_spec, C, V, N)
%__________________________________________________________________________
